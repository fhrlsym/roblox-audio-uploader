...
export const BTN_PRIMARY =
  'inline-flex items-center justify-center gap-2 rounded-xl bg-[var(--accent)] text-[var(--on-accent)] text-sm font-semibold px-4 py-2.5 transition duration-150 ease-out hover:brightness-105 active:scale-[0.97] disabled:cursor-not-allowed disabled:opacity-40 shadow-sm';
